...
namespace Core.Lib
{
//     public class DamageEndFrameTargetLogic : AbstractEntityLogic
//     {
...
//             _endFrameCall = _pools.EventEndFrameCall;
...
//                 return;
//
//             int target = _pools.Target.Get(entity).entity;
//             _inProgress = true;
//             var totalScale = _damageScale * _elementalDamage.GetScale();
//             _area.OnTriggerEnter2DWithDamageScale(target, totalScale, _priority);
//
