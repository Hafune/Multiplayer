...
{
    public class ValuePerSecondSystem<V, M, P> : IEcsRunSystem
        ...
        where P : struct, IValue //per second value
    {
        ...
        private readonly EcsPoolInject<P> _perSecondValuePool;
        ...
        {
            if (_perSecondValuePool.Value.Get(entity).value == 0)
                return;
        ...
        {
            var step = _perSecondValuePool.Value.Get(entity).value;
