...
{
    private readonly string dir = "Assets/Prefabs/Level/Details/Props/New Folder";
    private static readonly List<ValueTuple<int, ParticleSystem>> _particleSystems = new();
