...
namespace Lib
{
    ...
    {
        private static string path = "Assets/Core/Lib/LibTasks/Icons/";
        ...
        private static Texture2D choice = AssetDatabase.LoadAssetAtPath<Texture2D>(path + "choice.png");
