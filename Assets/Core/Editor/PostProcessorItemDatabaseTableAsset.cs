...
{
    [Obsolete]
    public class PostProcessorItemDatabaseTableAsset : AssetPostprocessor
    {
        ...
        private static string TEMPLATE = $@"//Файл генерируется в {nameof(PostProcessorItemDatabaseTableAsset)}
namespace Core
{{
    public enum {TARGET}
    {{
        ...
        //     _isDirty = false;
        //     
        //     ItemTemplates.ForEachEntity(i =>
        //     {
        //         var (id, dirty) = UpdateItemDatabase(i, ItemSourceEnum.ItemTemplateService);
        //         _isDirty = _isDirty || dirty;
        //         i.globalId = id;
        //     });
        //
        //     if (_isDirty)
