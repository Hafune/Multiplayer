...
public class EditorBatchPrefabCreateOrReplace : AbstractEditorBatchExecute
{
    private readonly string dir = "Assets/Additionals/Top-Down Dungeons/Prefabs";
    private static readonly Glossary<MeshFilter> _prefabs = new();
    ...
    private void ForChild(Transform t)
    {
        ...
        if (prefab)
        {
            ...
            PrefabUtility.ConvertToPrefabInstance(t.gameObject, prefab.gameObject, new ConvertToPrefabInstanceSettings {recordPropertyOverridesOfMatches = true}, InteractionMode.AutomatedAction);
        }
        else
        {
