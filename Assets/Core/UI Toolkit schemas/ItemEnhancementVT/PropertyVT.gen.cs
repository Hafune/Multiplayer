...
public class PropertyVT
{
    ...
    public VisualElement possiblePropertiesButton;
    
    public PropertyVT(VisualElement root)
    {
        container = root.Q<VisualElement>("Container");
        value = root.Q<Label>("Value");
        description = root.Q<Label>("Description");
        possiblePropertiesButton = root.Q<VisualElement>("PossiblePropertiesButton");
    }
}
