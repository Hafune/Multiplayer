...
public class ChestVT
{
    ...
    public Core.FocusableVisualElement chestArea;
    ...
    public ChestVT(VisualElement root)
    {
        chestArea = root.Q<Core.FocusableVisualElement>("ChestArea");
