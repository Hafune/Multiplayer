...
public class TooltipItemCompareRowVT
{
    ...
    public VisualElement compareRowContainer;
    public Label plus;
    public Label value;
    public Label percent;
    public Label valueDescription;
    
    public TooltipItemCompareRowVT(VisualElement root)
    {
        compareRowContainer = root.Q<VisualElement>("CompareRowContainer");
        plus = root.Q<Label>("Plus");
        value = root.Q<Label>("Value");
        percent = root.Q<Label>("Percent");
        valueDescription = root.Q<Label>("ValueDescription");
    }
}
